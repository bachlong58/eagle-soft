 ...
 *
 */
class Did_DidGroupController extends Core_Controller_Action
{
	public function indexAction()
	{		
		$this->view->headScript()->appendFile($this->sz_fGetPublicHost() . 'js/modules/did-group.js', 'text/javascript');
		$this->view->headTitle('Add Group');
	}
