 ...
 *
 */
class Did_DestinationController extends Core_Controller_Action
{		
public function indexAction()
	{		
		$this->view->headScript()->appendFile($this->sz_fGetPublicHost() . 'js/modules/destination.js', 'text/javascript');
		$this->view->headTitle('Add CID');
		/*$o_GroupModel = new Model_DestinationGroup();
