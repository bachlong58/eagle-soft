<?php
class Model_Table_DidGroup extends Zend_Db_Table_Abstract
{
	protected $_name = 'cc_didgroup';
	...
	{		
		$o_Select = $this->_db->select()->from($this->_name, array('*'))->where("didgroupname like ?", "%" . $the_a_Data['groupname'] . "%");
